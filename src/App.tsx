        ...
        <section id="books" className="scroll-mt-24 md:scroll-mt-32">
          ...
          <div className="grid grid-cols-1 gap-12 max-w-6xl mx-auto px-4 md:px-0">
            {[
              ...
              {
                title: "التعافي من الإدمان",
                author: "روبرت وست",
                desc: "كتاب شامل يغطي الجوانب العلمية والعملية للتعافي، موضحاً المسارات المختلفة التي يمكن أن يسلكها الفرد للتحرر من القيود الإدمانية.",
                icon: <Compass className="text-green-500" size={24} />,
                cover: "https://covers.openlibrary.org/b/isbn/9781845908850-L.jpg",
                buyUrl: "https://www.amazon.com/Recovery-Freedom-Our-Addictions-Book/dp/1250182930"
              },
              {
